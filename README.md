...
> This repository contains the **STream3R-based** implementation of Scal3R. For the CUT3R-based implementation, see [Scal3R](https://github.com/NVlabs/scal3r).
...
1. Clone Scal3R.
```bash
git clone --branch scal3r_stream3r https://github.com/NVlabs/scal3r.git
cd scal3r
```
